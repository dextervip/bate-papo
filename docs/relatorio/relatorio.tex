...
\section{Protocolo}		
O protocolo escolhido para ser implementado foi o TCP/IP pois ele é um protocolo confiavel, ou seja, as mensagens do chat nao serão perdidas embora possam demorar um certo tempo para chegar, alem de possuir controle de fluxo e squenciamento das mensagens. 
